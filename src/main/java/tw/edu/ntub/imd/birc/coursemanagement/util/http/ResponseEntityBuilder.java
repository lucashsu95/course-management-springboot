...
import tw.edu.ntub.imd.birc.coursemanagement.util.function.TripleConsumer;
import tw.edu.ntub.imd.birc.coursemanagement.util.json.ResponseData;
import tw.edu.ntub.imd.birc.coursemanagement.util.json.array.ArrayData;
import tw.edu.ntub.imd.birc.coursemanagement.util.json.array.CollectionArrayData;
import tw.edu.ntub.imd.birc.coursemanagement.util.json.array.MapArrayData;
import tw.edu.ntub.imd.birc.coursemanagement.util.json.object.ObjectData;
import tw.edu.ntub.imd.birc.coursemanagement.dto.CodeEntry;
import tw.edu.ntub.imd.birc.coursemanagement.util.function.AddObjectDataConsumer;
import tw.edu.ntub.imd.birc.coursemanagement.util.function.AddObjectDataMapConsumer;
