package tw.edu.ntub.imd.birc.coursemanagement.util.file;
...
import tw.edu.ntub.imd.birc.coursemanagement.exception.file.InvalidCharsetException;
import tw.edu.ntub.imd.birc.coursemanagement.exception.file.InvalidOptionException;
import tw.edu.ntub.imd.birc.coursemanagement.exception.file.UnauthorizedException;
...
public class FileUtils {
    ...
    public Path getFilePath(@NonNull String filePath) {
        try {
            ...
            throw new tw.edu.ntub.imd.birc.coursemanagement.exception.file.InvalidPathException(e, filePath);
        }
    }
    ...
    public Path getDirectoryPath(@NonNull String firstDirectoryPath, String... subDirectoryPath) {
        try {
            ...
            throw new tw.edu.ntub.imd.birc.coursemanagement.exception.file.InvalidPathException(e, firstDirectoryPath, subDirectoryPath);
        }
    }
